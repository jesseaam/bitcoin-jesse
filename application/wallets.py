...
def repeat_wallet(repeat_word, mnemonic_size):
    ...
    Output
        mn_single: <class 'str'> The mnemonic phrase using the repeat_word and mnemonic_size. Note it is hard coded to just manually choose one of multiple possibilites.
    ...
    return (mn_all, mn_single, tot, funded, summary, addr0, results)

print(repeat_wallet(repeat_word="abandon", mnemonic_size=12))
mn_all, mn_single, tot, funded, summary, addr0, results = repeat_wallet(repeat_word="abandon", mnemonic_size=12)
print(type(mn_single))
print(type(summary))
print(type(addr0))
print(type(results))